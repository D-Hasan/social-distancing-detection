...
filename = '/Users/gabriel/PycharmProjects/420Project/social-distancing-monitoring/statistic_data.p'
filename = '/Users/gabriel/PycharmProjects/420Project/social-distancing-monitoring/results/statistic_data_rcnn.p'

def get_labels(filename,inter_frame_dist):
    '''
...
def plott(labels,data,curr_frame):
    ...
    #imageio.mimsave('./powers.gif', ppp, fps=len(data)/25)
